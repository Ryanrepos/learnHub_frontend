import { useGetMyCourses, useGetCourses } from "../../composables/useCourses";
import { useGetMe } from "../../composables/useLogin";
import { StyledDashboard } from "./DashboardHero.ts";
    ...
    return (
        <StyledDashboard>
            ...
            <div className="section">
                <h2 className="section-title">My Active Courses</h2>
                    ...
                    {courses.slice(0, 3).map((enrollment: any) => (
                        <div key={enrollment.course?.id} className="course-card">
                            ...
                            <div className="course-info">
                                ...
                                <p className="progress-text">40% Complete</p>
                                <button
            ...
            <div className="section">
                ...
                <p className="section-subtitle">You've finished these. Great job!</p>

                <div className="courses-grid">
                    {mockCompleted.map((course) => (
                        <div key={course.id} className="course-card">
                            ...
                            <div className="course-info">
                                ...
                                <p className="course-level">{course.instructor}</p>
